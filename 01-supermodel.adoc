...
Entities are commonly created by Agents through Activities and all of the people and organisations related to objects in the model are Agents, e.g. the creators of a dataset.
